...
const Home = () => {
 ...
 const   productsArr = [
  {
    imgsrc : "https://images.unsplash.com/photo-1525966222134-fcfa99b8ae77?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1898&q=80",
  ...
  return (
    <>
      <div className="homeComp">
        ...
        {
          buttonArray.map((i)=>(
            <button key={i.id} className="topBtns">{i.name}</button>
          ))
        }
      </div>
